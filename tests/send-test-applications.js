...
const testApplications = [
  {
    ...
    expectedRecipient: "careers@hyniva.com (US)"
  },
  {
  ...
  },
  {
    ...
    expectedRecipient: "hr@hyniva.com (Non-US)"
  },
  {
...
async function runTestSuite() {
  ...
  console.log("\n" + "=".repeat(80));
  console.log("\n📧 NEXT STEPS:");
  console.log("1. Check careers@hyniva.com for US applications");
  console.log("2. Check hr@hyniva.com for Non-US applications");
