            ...
            >
                ...
                <div className="relative z-10 flex flex-col items-center text-center px-6 sm:px-16 pt-16 pb-20 sm:pt-20 sm:pb-24">
                    <motion.div variants={scrollReveal} initial="hidden" whileInView="visible" viewport={viewportOnce} className="flex flex-col items-center w-full">
                        ...
                        <div className="inline-flex items-center gap-2 text-[11px] font-bold tracking-[2px] uppercase text-[#00D4AA] bg-[#00D4AA]/[0.08] border border-[#00D4AA]/25 rounded-full px-5 py-1.5 mb-8">
                        ...
                        <Link
                            href={cta.href}
                            className="group inline-flex items-center gap-2.5 font-bold text-[15px] text-[#030B3B] bg-gradient-to-r from-[#00D4AA] to-[#00A8FF] rounded-full px-10 py-[18px] transition-all duration-300 hover:-translate-y-1 shadow-[0_8px_32px_rgba(0,212,170,0.28)] hover:shadow-[0_20px_52px_rgba(0,212,170,0.4)] tracking-[-0.2px]"
                        >
                            {cta.label}
