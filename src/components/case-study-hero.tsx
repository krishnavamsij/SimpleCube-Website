            ...
            <div className="relative z-10 w-full max-w-[1000px] px-8 mx-auto text-center pt-20">
                <div className="max-w-4xl mx-auto">
                    ...
                    <motion.h1
                        ...
                        className="text-[28px] md:text-[38px] lg:text-[52px] font-black text-white tracking-tight leading-[1.15] mb-8 font-sans cs-line-clamp-2"
                    >
                        {title}
                    </motion.h1>
                    ...
                    <motion.p
                        ...
                        className="text-[14px] md:text-[16px] text-white/90 font-light leading-relaxed max-w-2xl mx-auto mb-16 cs-line-clamp-2"
                    >
                        {summary}
                    </motion.p>
                        ...
                        {metrics.map((metric, idx) => (
                            <div key={idx} className="relative py-10 px-4 group cursor-default hover:bg-[#1e90ff0d] transition-all duration-300 rounded-b-xl overflow-hidden">
                                ...
                                <div className="flex flex-col items-center relative z-10">
                                    ...
                                    <StandardIcon icon={metric.icon} className="mb-5" />
                                    
                                    {/* Main Number - Centered - Force 1 line with smaller font */}
                                    <div className="text-[20px] lg:text-[28px] font-bold text-white tracking-tight leading-none mb-3 font-display group-hover:text-[#63c2ff] group-hover:drop-shadow-[0_0_30px_#63c2ff80] transition-all duration-300 whitespace-nowrap text-center px-1">
                                        {metric.value}
                                    </div>
                                    ...
                                    <div className="flex flex-col justify-center text-center max-w-[100px] text-[10px] lg:text-[11px] font-medium text-white mx-auto cs-force-2-lines-safe">
                                        {metric.label}
                                    </div>
                                </div>
