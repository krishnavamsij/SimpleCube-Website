            ...
            <div className="mx-auto max-w-[96rem] px-6 md:px-10 lg:px-16">
                ...
                >
                    ...
                    <h2 className="text-[28px] sm:text-[44px] lg:text-[44px] 2xl:text-[52px] font-extrabold tracking-tight text-slate-900 leading-[1.1] whitespace-normal break-words max-w-full">
                        Challenges we <span className="text-[#3886CE]">solve.</span>
                    </h2>
                </motion.div>
                    ...
                    {challenges.map((challenge) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Title */}
                                <h3 className="text-[14px] lg:text-[15px] font-black text-[#0A2F52] leading-tight mb-2 tracking-tight xl:whitespace-nowrap flex-shrink-0 font-display">
                                    {challenge.title}
                                </h3>
