export const wealthAssetManagementContent = {
    hero: {
        ...
        title: "Redefining wealth management through intelligent and personalized investor experiences",
        subtitle: "Connected advisory journeys, real-time portfolio intelligence and AI-driven engagement across the investment lifecycle.",
