export const caseStudiesContent = {
    ...
    studies: [
        ...
        {
            title: "<span class='text-[#3886CE]'>Faster Loan Processing</span> with Agentforce Document AI",
        ...
        {
            title: "<span class='text-[#3886CE]'>Intelligent Claims Orchestration</span> with Claim Pioneer",
        ...
        {
            title: "<span class='text-[#3886CE]'>Transforming Claims Operations</span> with Intelligent Assignment",
        ...
        {
            title: "<span class='text-[#3886CE]'>Intelligent School Administration</span> for Modern Institutions",
        ...
        {
            title: "<span class='text-[#3886CE]'>Streamlining Field Claims</span> with Mobile-First Execution",
        ...
        {
            title: "<span class='text-[#3886CE]'>AWS-Powered Document</span> Platform Transformation",
        ...
        {
            title: "<span class='text-[#3886CE]'>Data-Driven Campaign Management</span> for Enterprise Marketing",
        ...
        {
            title: "<span class='text-[#3886CE]'>Modernizing Case Management</span> for Healthcare Providers",
        ...
        {
            title: "<span class='text-[#3886CE]'>Transforming Claims</span> with a Connected Customer Experience",
        ...
        {
            title: "Simplifying School Operations with a <span class='text-[#3886CE]'>Unified Digital Management Platform</span>",
        ...
        {
            title: "<span class='text-[#3886CE]'>Optimizing Loan Routing</span> and Pre-Qualification with AI",
        ...
        {
            title: "Legacy CRM to <span class='text-[#3886CE]'>Modern Lending Platform</span>",
        ...
        {
            title: "Enabling <span class='text-[#3886CE]'>Zero-Downtime Deployments</span> with AWS",
        ...
        {
            title: "Building a Mobile-First, <span class='text-[#3886CE]'>Real-Time Logistics Platform</span>",
        ...
        {
            title: "<span class='text-[#3886CE]'>AI-Powered Customer Support</span> Automation",
        ...
        {
            title: "Transforming Government Schools with <span class='text-[#3886CE]'>AI-Powered Management</span>",
