...
export const insuranceContent = {
    hero: {
        badge: "INSURANCE",
        title: "Redefining insurance operations through AI-driven claims orchestration",
        subtitle: "Automated claim assignment, intelligent field coordination and real-time servicing across the insurance lifecycle.",
