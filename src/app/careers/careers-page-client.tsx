...
function CareersPageContent({ turnstileSiteKey }: CareersPageClientProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (turnstileEnabled && !turnstileToken) {
      setSubmitError("Please complete the spam verification check.");
      return;
    }
  ...
  const canSubmit =
    !isSubmitting && (!turnstileEnabled || Boolean(turnstileToken));
...
export default function CareersPageClient({
  ...
  return (
    ...
    >
      <CareersPageContent turnstileSiteKey={turnstileSiteKey} />
    </Suspense>
  );
}
