...
const jobOpenings: JobPosition[] = [
  ...
  },
  {
    ...
    jobDuties: [
      ...
      "Implement application and workflow state management using Azure Cosmos DB",
      "Integrate with enterprise platforms, including tenant routing and configuration management",
      "Automate infrastructure deployment using Azure Bicep and CI/CD pipelines",
      "Manage application configuration and secrets using Azure App Configuration and Azure Key Vault",
      "Ensure security, scalability, reliability, and compliance with architecture standards",
      "Lead technical design discussions, code reviews, and mentoring of development teams"
    ],
    qualifications: {
      degree: "Bachelor's or Master's degree in Computer Science, Engineering, or related field",
      experience: "5+ Years",
    },
    skillsRequired: [
      "5+ years of software development experience with Azure",
      ...
      "Technical leadership and team mentoring (Preferred)"
    ],
    region: "india",
  },
  {
    ...
    skillsRequired: [
      "8+ years of experience, including architecture and team leadership responsibilities",
      "Strong experience with C#/.NET",
      "Azure Functions",
      "Azure API Management (APIM)",
      "Azure Cosmos DB",
