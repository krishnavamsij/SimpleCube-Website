    ...
    <div className="min-h-screen bg-white font-sans text-[#030B3B]">
      ...
      <main className="pt-32 pb-24 mx-auto w-full max-w-[1400px] px-12 sm:px-16 lg:px-20 xl:px-24 2xl:px-32">
        ...
        >
          ...
          >
            Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <strong><a href="mailto:hr@hyniva.com" className="text-[#3B82F6] hover:underline">hr@hyniva.com</a></strong>.
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="space-y-4">
            ...
            <p className="text-[15px] font-medium text-[#030B3B]/70 leading-relaxed mb-4 max-w-6xl text-left">
            ...
            <p className="text-[15px] font-medium text-[#030B3B]/70 leading-relaxed max-w-6xl text-left">
          ...
          <motion.div variants={fadeInUp} className="space-y-4">
            ...
            <ul className="space-y-2 ml-6">
              ...
              <li className="text-gray-700 leading-relaxed max-w-6xl text-left">To exercise these rights, you can contact us by email at <strong><a href="mailto:hr@hyniva.com" className="text-[#3B82F6] hover:underline">hr@hyniva.com</a></strong>, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</li>
            </ul>
          </motion.div>
