...
export default function CaseStudiesPage() {
    ...
    const categories = useMemo(() => {
        ...
        caseStudiesContent.studies.forEach(study => {
            ...
            if (!title.includes('AI-Powered') && !title.includes('Microsoft') && !title.includes('AWS') && 
                !title.includes('LWR') && !title.includes('Agentforce') && !title.includes('FinXserve') && !title.includes('CRM')) {
                cats.add('Other');
            }
        });
    ...
    const filteredStudies = useMemo(() => {
        return caseStudiesContent.studies.filter(study => {
            ...
            const matchesCategory = selectedCategory === 'All' || 
                ...
                (selectedCategory === 'Salesforce' && (title.includes('LWR') || title.includes('Agentforce'))) ||
                (selectedCategory === 'Banking' && title.includes('FinXserve')) ||
                (selectedCategory === 'CRM' && title.includes('CRM')) ||
                (selectedCategory === 'Other' && !title.includes('AI-Powered') && !title.includes('Microsoft') && 
                    !title.includes('AWS') && !title.includes('LWR') && !title.includes('Agentforce') && 
                    !title.includes('FinXserve') && !title.includes('CRM'));
