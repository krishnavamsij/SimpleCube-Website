        ...
        <section className="bg-[#F8FAFC] border-t border-[#0A2F52]/10 py-16 sm:py-20">
            <div className="mx-auto w-full max-w-[1400px] px-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                    <div>
                        <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#0A2F52] leading-snug">Related News</h3>
                    ...
                    <div className="flex gap-3">
                        <button
                            ...
                            className="w-12 h-12 rounded-full border border-[#0A2F52]/10 flex items-center justify-center hover:bg-[#0A2F52] hover:text-white transition-all disabled:opacity-30 disabled:cursor-not-allowed"
...
export default function NewsDetailPage() {
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-[#0A2F52] overflow-x-hidden">
            ...
            {/* ── Hero Section ── */}
            <header className="relative pt-24 pb-28 overflow-hidden bg-[#0A2F52] flex flex-col items-center">
                            ...
                            {post.sections.map((section) => (
                                ...
                                >
                                    ...
                                    >
                                        {section.title && (
                                            <div className="mb-8">
                                                <h2 className="text-2xl sm:text-[26px] font-bold text-[#0A2F52] leading-[1.2] text-left font-display">{section.title}</h2>
                                            </div>
                                        )}
            ...
            <style dangerouslySetInnerHTML={{
                ...
                .blog-content h2 { font-family: var(--font-display), serif; font-size: clamp(20px, 2.4vw, 26px); color: #0A2F52; margin: 52px 0 16px; line-height: 1.3; font-weight: 400; }
                .hero-title em { font-style: normal; color: white !important; } 
                .blog-content em { font-style: italic; color: #1e6fff; }
                .blog-content strong { font-weight: 600; color: #0A2F52; }
                ...
                .listen-card__platform { font-size: 13.5px; font-weight: 600; color: #0A2F52; margin-bottom: 2px; text-align: left; }
                ...
                .type-card__title { font-family: var(--font-display), serif; font-size: 18px; color: #0A2F52; margin-bottom: 10px; }
                ...
                .process-step__title { font-size: 14px; font-weight: 600; color: #0A2F52; margin-bottom: 4px; }
                ...
                .benefit__title { font-size: 14px; font-weight: 600; color: #0A2F52; margin-bottom: 8px; display: flex; align-items: center; gap: 8px; }
                ...
                .benefit-card__title { font-size: 15px; font-weight: 600; color: #0A2F52; margin-bottom: 5px; }
                ...
                .highlight-card__title { font-size: 15px; font-weight: 600; color: #0A2F52; margin-bottom: 6px; }
                ...
                .pillar__title { font-size: 14px; font-weight: 600; color: #0A2F52; margin-bottom: 6px; }
                ...
                .value-card__title { font-size: 15px; font-weight: 600; color: #0A2F52; margin-bottom: 5px; }
                .value-card__body { font-size: 15px; font-weight: 300; color: #4a5568; line-height: 1.75; }

                /* ─── PULLQUOTE ─── */
                .pullquote { margin: 40px 0; padding: 4px 0 4px 32px; margin-bottom: 32px; border-left: 4px solid #3886CE; }
                .pullquote__text { font-family: var(--font-display), serif; font-size: 18px; font-style: normal; color: #0A2F52; line-height: 1.6; }
                ...
                .quote-block { margin-top: 48px; background: #0A2F52; border-radius: 14px; padding: 40px 36px; position: relative; overflow: hidden; margin-bottom: 24px; }
                ...
                .thankyou__title { position: relative; z-index: 1; font-family: var(--font-display), serif; font-size: clamp(20px, 2.4vw, 24px); color: #0A2F52; margin-bottom: 14px; font-weight: 500; }
                ...
                .ongoing__title { font-family: var(--font-display), serif; font-size: 20px; color: #0A2F52; margin-bottom: 18px; }
                ...
                /* ─── CTA ─── */
                .cta { margin-top: 72px; background: #0A2F52; border-radius: 16px; padding: 52px 48px; display: flex; align-items: center; justify-content: space-between; gap: 32px; flex-wrap: wrap; position: relative; overflow: hidden; }
                ...
                .day-card__title { position: relative; z-index: 1; font-family: var(--font-display), serif; font-size: clamp(16px, 2vw, 20px); font-weight: 600; color: #0A2F52; }
                ...
                .aira-block__header { background: #0A2F52; padding: 24px 28px; position: relative; overflow: hidden; }
