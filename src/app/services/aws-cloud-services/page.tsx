...
import { ArrowUpRightIcon, Cloud, Database, Shield, Settings, Monitor, Cpu, Zap, ArrowRight } from "lucide-react";
import { Navbar } from "@/components/navbar";
import { Footer } from "@/components/footer";
import { awsCloudServicesContent } from "@/content/aws-cloud-services";
import {
    scrollReveal,
        ...
        <section className="relative overflow-hidden py-20 pt-32 sm:py-28 sm:pt-36 md:py-32 md:pt-44 lg:py-36 lg:pt-48">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    >
                        {awsCloudServicesContent.hero.title}
                    </motion.h1>
                    <motion.p
                        variants={fadeInUp}
                        className="mt-4 text-lg text-slate-200 sm:text-xl"
                    >
                        {awsCloudServicesContent.hero.subtitle}
                    </motion.p>
                    <motion.div
                        variants={fadeInUp}
                        className="mt-8"
                    >
                        <Link
                            href={awsCloudServicesContent.hero.contactButton.href}
                        ...
                        >
                            {awsCloudServicesContent.hero.contactButton.text}
...
function AWSCloudServicesIntro() {
    return (
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h3 className="text-xl font-bold leading-snug sm:text-2xl md:text-3xl mb-4 text-blue-900">
                        {awsCloudServicesContent.intro.title}
                    </h3>
                    <p className="text-base leading-relaxed text-slate-600 sm:text-lg">
                        {awsCloudServicesContent.intro.description}
                    </p>
                </motion.div>
            </div>
        </section>
...
function ServicesGrid() {
    const { services } = awsCloudServicesContent;
...
function CaseStudiesSection() {
    const { caseStudies } = awsCloudServicesContent;
...
function DeliveryEnablers() {
    const { deliveryEnablers } = awsCloudServicesContent;
...
function AWSCloudServicesCTA() {
    return (
        <section className="relative overflow-hidden py-20 sm:py-24">
            {/* Background */}
            <div 
                className="absolute inset-0 bg-cover bg-center bg-no-repeat"
                style={{ backgroundImage: `url('${awsCloudServicesContent.cta.backgroundImage}')` }}
            />
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h3 className="text-2xl font-extrabold tracking-tight text-white sm:text-3xl md:text-4xl lg:text-5xl font-bricolage">
                        {awsCloudServicesContent.cta.title}
                    </h3>
                    <div className="mt-8 flex justify-center">
                        <Link
                            href={awsCloudServicesContent.cta.buttonHref}
                        ...
                        >
                            {awsCloudServicesContent.cta.buttonText}
                            <ArrowUpRightIcon className="h-4 w-4" />
                        </Link>
                    </div>
                </motion.div>
...
export default function AWSCloudServicesPage() {
    return (
        <>
            <Navbar />
            <main>
                <AWSCloudServicesHero />
                <AWSCloudServicesIntro />
                <ServicesGrid />
                <CaseStudiesSection />
                <DeliveryEnablers />
                <AWSCloudServicesCTA />
