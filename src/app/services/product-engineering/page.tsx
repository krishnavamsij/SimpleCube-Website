            ...
            <div className="relative z-10 mx-auto w-full max-w-[96rem] px-6 md:px-10 lg:px-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center pb-10 pt-[110px] sm:pb-10 sm:pt-[120px] lg:pb-12 lg:pt-20">
                    ...
                    >
                        ...
                        >
                            <span className="inline-block whitespace-nowrap">Engineer <span className="text-[#00D4AA]">products.</span></span><br className="hidden sm:block" />{" "}
                            <span className="inline-block whitespace-nowrap">Deliver <span className="text-[#00D4AA]">lasting value.</span></span>
                        </motion.h1>
                        <motion.p
                            variants={animations.fadeInUp}
