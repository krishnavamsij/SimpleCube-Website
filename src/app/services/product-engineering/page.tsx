            ...
            <div className="relative z-10 mx-auto w-full max-w-[96rem] px-6 md:px-10 lg:px-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center pb-10 pt-[110px] sm:pb-10 sm:pt-[120px] lg:pb-12 lg:pt-20">
                    ...
                    >
                        ...
                        >
                            <span className="inline-block whitespace-nowrap">Engineer <span className="text-[#3886CE]">products.</span></span><br className="hidden sm:block" />{" "}
                            <span className="inline-block whitespace-nowrap">Deliver <span className="text-[#3886CE]">lasting value.</span></span>
                        </motion.h1>
                        <motion.p
                            variants={animations.fadeInUp}
                            ...
                            <svg viewBox="-50 -50 1100 600" className="w-full h-full relative z-10 overflow-visible" xmlns="http://www.w3.org/2000/svg">
                                <defs>
                                    <linearGradient id="globalGrad" x1="100" y1="250" x2="930" y2="250" gradientUnits="userSpaceOnUse">
                                        ...
                                        <stop offset="65%" stopColor="#135498" />
            ...
            <div className="relative z-10 mx-auto max-w-[96rem] px-6 md:px-10 lg:px-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
                    {challenges.map((card, idx) => (
                        ...
                        >
                            <div className="flex-shrink-0 h-12 w-12 rounded-xl flex items-center justify-center bg-[#EFF6FF] text-[#3886CE] transition-all duration-300 group-hover:bg-[#135498] group-hover:text-white group-hover:scale-105">
                                <card.icon className="h-6 w-6 transition-colors duration-300" />
                            </div>
                            <p className="text-sm sm:text-[15px] font-medium text-[#0A2F52]/80 leading-relaxed">
                                {card.description}
                            </p>
                        </motion.div>
                    ))}
    ...
    const enablers = [
        {
            ...
            icon: Rocket,
            iconBg: "bg-[#e8f1fa] group-hover:bg-[#e8f1fa]0",
            iconColor: "text-[#135498] group-hover:text-white",
                    ...
                    <div className="lg:w-[72%] grid grid-cols-1 md:grid-cols-3 gap-5 xl:gap-6">
                        {enablers.map((item, idx) => (
                            ...
                            >
                                ...
                                <h3 className="text-[17px] font-bold text-[#0A2F52] mb-2.5 transition-colors duration-300">{item.title}</h3>
...
function TransformationInAction() {
    const caseStudies = [
        ...
        {
            title: "<span class='text-[#3886CE]'>Scalable Multi-Portal Platform</span> for Complex Education Workflows",
        ...
        {
            title: "<span class='text-[#3886CE]'>Transforming Claims Operations</span> with a Scalable Digital Platform",
                    ...
                    <div className="relative z-10 grid gap-8 md:gap-12 md:grid-cols-[1fr_auto] items-start">
                        ...
                        <div className="flex flex-col items-start">
                            ...
                            <h2 className="text-[20px] sm:text-[24px] md:text-[26px] lg:text-[29px] xl:text-[30px] font-[900] text-white tracking-tight leading-[1.18] font-display">
                                ...
                                <span className="text-[#3886CE] block">Product Engineering?</span>
                            </h2>
                        </div>
                            ...
                            <div className="grid grid-cols-3 gap-3 sm:flex sm:flex-wrap items-start justify-start sm:gap-8 lg:gap-10 xl:gap-12 w-full">
                                <div className="flex flex-col items-start">
                                    <div className="flex items-baseline gap-0.5 mb-1">
                                        <span className="text-[22px] xs:text-[26px] sm:text-[30px] lg:text-[32px] font-[900] text-white leading-none font-display">17</span>
                                    </div>
                                ...
                                <div className="flex flex-col items-start">
                                    <div className="flex items-baseline gap-0.5 mb-1">
                                        <span className="text-[22px] xs:text-[26px] sm:text-[30px] lg:text-[32px] font-[900] text-white leading-none font-display">7</span>
                                    </div>
                                    <span className="text-[10px] xs:text-[11px] sm:text-[11.5px] lg:text-[12px] text-slate-400 font-medium whitespace-pre-line leading-[1.3] sm:leading-[1.4]">
                                        {"Enterprise\nProducts Built"}
                                    </span>
                                ...
                                <div className="flex flex-col items-start">
                                    <div className="flex items-baseline gap-0.5 mb-1">
                                        <span className="text-[22px] xs:text-[26px] sm:text-[30px] lg:text-[32px] font-[900] text-white leading-none font-display">2</span>
                                    </div>
                                    <span className="text-[10px] xs:text-[11px] sm:text-[11.5px] lg:text-[12px] text-slate-400 font-medium whitespace-pre-line leading-[1.3] sm:leading-[1.4]">
                                        {"Successfully\nAcquired Products"}
                                    </span>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 xl:gap-12">
                        {bottomBox.map((card, idx) => (
                            <div key={idx} className="flex flex-col">
                                ...
                                <h3 className="text-[15px] lg:text-[16px] font-black text-[#0A2F52] mb-2 leading-tight font-display whitespace-pre-line">
                                    {card.title}
                                </h3>
