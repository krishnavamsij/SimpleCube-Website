...
import { ArrowUpRightIcon, MessageCircle, Cpu, FileText, ArrowRight } from "lucide-react";
import { Navbar } from "@/components/navbar";
import { Footer } from "@/components/footer";
import { appliedAIContent } from "@/content/applied-ai";
import {
    scrollReveal,
        ...
        <section className="relative overflow-hidden py-20 pt-32 sm:py-28 sm:pt-36 md:py-32 md:pt-44 lg:py-36 lg:pt-48">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    >
                        {appliedAIContent.hero.title}
                    </motion.h1>
                    <motion.p
                        variants={fadeInUp}
                        className="mt-4 text-lg text-slate-200 sm:text-xl"
                    >
                        {appliedAIContent.hero.subtitle}
                    </motion.p>
                    <motion.div
                        variants={fadeInUp}
                        className="mt-8"
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-base leading-relaxed text-slate-600 sm:text-lg">
                        {appliedAIContent.intro.description}
                    </p>
                </motion.div>
            </div>
        </section>
...
function ServicesGrid() {
    const { services } = appliedAIContent;
...
function CaseStudiesSection() {
    const { caseStudies } = appliedAIContent;
...
function DeliveryEnablers() {
    const { deliveryEnablers } = appliedAIContent;
...
function AppliedAICTA() {
    return (
        <section className="relative overflow-hidden py-20 sm:py-24">
            {/* Background */}
            <div 
                className="absolute inset-0 bg-cover bg-center bg-no-repeat"
                style={{ backgroundImage: `url('${appliedAIContent.cta.backgroundImage}')` }}
            />
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h3 className="text-2xl font-extrabold tracking-tight text-white sm:text-3xl md:text-4xl lg:text-5xl font-bricolage">
                        {appliedAIContent.cta.title}
                    </h3>
                    <div className="mt-8 flex justify-center">
                        <Link
                            href={appliedAIContent.cta.buttonHref}
                        ...
                        >
                            {appliedAIContent.cta.buttonText}
                            <ArrowUpRightIcon className="h-4 w-4" />
                        </Link>
                    </div>
                </motion.div>
