    ...
    return (
        <section className="relative overflow-hidden py-20 pt-32 sm:py-28 sm:pt-36 md:py-32 md:pt-44 lg:py-36 lg:pt-48">
            ...
            <div 
                ...
                style={{ backgroundImage: `url('${cloudMigrationContent.hero.backgroundImage}')` }}
            />
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    >
                        {cloudMigrationContent.hero.title}
                    </motion.h1>
                    <motion.p
                        variants={fadeInUp}
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h3 className="text-xl font-bold leading-snug sm:text-2xl md:text-3xl mb-4 text-blue-900">
                        {cloudMigrationContent.intro.title}
                    </h3>
                    <p className="text-base leading-relaxed text-slate-600 sm:text-lg">
                        {cloudMigrationContent.intro.description}
                    </p>
                </motion.div>
            </div>
        </section>
...
function ServicesGrid() {
    const { services } = cloudMigrationContent;
...
function DeliveryEnablers() {
    const { deliveryEnablers } = cloudMigrationContent;
...
function CloudMigrationCTA() {
    return (
        <section className="relative overflow-hidden py-20 sm:py-24">
            {/* Background */}
            <div 
                className="absolute inset-0 bg-cover bg-center bg-no-repeat"
                style={{ backgroundImage: `url('${cloudMigrationContent.cta.backgroundImage}')` }}
            />
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h3 className="text-2xl font-extrabold tracking-tight text-white sm:text-3xl md:text-4xl lg:text-5xl font-bricolage">
                        {cloudMigrationContent.cta.title}
                    </h3>
                    <div className="mt-8 flex justify-center">
                        <Link
                            href={cloudMigrationContent.cta.buttonHref}
                        ...
                        >
                            {cloudMigrationContent.cta.buttonText}
                            <ArrowUpRightIcon className="h-4 w-4" />
                        </Link>
                    </div>
                </motion.div>
