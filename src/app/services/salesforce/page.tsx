...
import { ArrowUpRightIcon, Users, Settings, Smartphone, BarChart3, Cloud, Shield, ArrowRight } from "lucide-react";
...
function ServiceCard({
    ...
    service: (typeof salesforceContent.services)[number];
    index: number;
}) {
...
function CaseStudyCard({
    ...
    caseStudy: (typeof salesforceContent.caseStudies)[number];
    index: number;
}) {
    return (
        <motion.div
    ...
    return (
        <section className="relative overflow-hidden py-20 pt-32 sm:py-28 sm:pt-36 md:py-32 md:pt-44 lg:py-36 lg:pt-48">
            ...
            <div 
                ...
                style={{ backgroundImage: `url('${salesforceContent.hero.backgroundImage}')` }}
            />
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h3 className="text-xl font-bold leading-snug sm:text-2xl md:text-3xl mb-4 text-blue-900">
                        {salesforceContent.intro.title}
                    </h3>
                    <p className="text-base leading-relaxed text-slate-600 sm:text-lg">
                        {salesforceContent.intro.description}
                    </p>
                </motion.div>
            </div>
        </section>
...
function ServicesGrid() {
    const { services } = salesforceContent;
...
function CaseStudiesSection() {
    const { caseStudies } = salesforceContent;
    ...
    return (
        <section className="bg-white py-16 sm:py-20">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-xl font-bold tracking-tight sm:text-2xl md:text-3xl text-blue-900">
                        Salesforce Case Studies & Insights
                    </h2>
                </motion.div>
                <motion.div
                    variants={scrollStaggerContainer}
...
function DeliveryEnablers() {
    const { deliveryEnablers } = salesforceContent;
...
function SalesforceCTA() {
    return (
        <section className="relative overflow-hidden py-20 sm:py-24">
            ...
            <div 
                className="absolute inset-0 bg-cover bg-center bg-no-repeat"
                style={{ backgroundImage: `url('${salesforceContent.cta.backgroundImage}')` }}
            />
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h3 className="text-2xl font-extrabold tracking-tight text-white sm:text-3xl md:text-4xl lg:text-5xl font-bricolage">
                        {salesforceContent.cta.title}
                    </h3>
                    <div className="mt-8 flex justify-center">
                        <Link
                            href={salesforceContent.cta.buttonHref}
                        ...
                        >
                            {salesforceContent.cta.buttonText}
                            <ArrowUpRightIcon className="h-4 w-4" />
                        </Link>
                    </div>
                </motion.div>
