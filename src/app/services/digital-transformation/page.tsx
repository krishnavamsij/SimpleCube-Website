...
import { ArrowUpRightIcon, Monitor, Map, Shield, Radio, Cloud, ArrowRight } from "lucide-react";
import { Navbar } from "@/components/navbar";
import { Footer } from "@/components/footer";
import { digitalTransformationContent } from "@/content/digital-transformation";
import {
    scrollReveal,
...
function ServiceCard({
    ...
    service: (typeof digitalTransformationContent.services)[number];
    index: number;
}) {
...
function CaseStudyCard({
    ...
    caseStudy: (typeof digitalTransformationContent.caseStudies)[number];
    index: number;
}) {
    return (
        <motion.div
    ...
    return (
        <section className="relative overflow-hidden py-20 pt-32 sm:py-28 sm:pt-36 md:py-32 md:pt-44 lg:py-36 lg:pt-48">
            ...
            <div 
                ...
                style={{ backgroundImage: `url('${digitalTransformationContent.hero.backgroundImage}')` }}
            />
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    >
                        ...
                        >
                            {digitalTransformationContent.hero.contactButton.text}
...
function DigitalTransformationIntro() {
    return (
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h3 className="text-xl font-bold leading-snug sm:text-2xl md:text-3xl mb-4 text-blue-900">
                        {digitalTransformationContent.intro.title}
                    </h3>
                    <p className="text-base leading-relaxed text-slate-600 sm:text-lg">
                        {digitalTransformationContent.intro.description}
                    </p>
                </motion.div>
            </div>
        </section>
...
function ServicesGrid() {
    const { services } = digitalTransformationContent;
...
function CaseStudiesSection() {
    const { caseStudies } = digitalTransformationContent;
...
function DeliveryEnablers() {
    const { deliveryEnablers } = digitalTransformationContent;
...
function DigitalTransformationCTA() {
    return (
        <section className="relative overflow-hidden py-20 sm:py-24">
            {/* Background */}
            <div 
                className="absolute inset-0 bg-cover bg-center bg-no-repeat"
                style={{ backgroundImage: `url('${digitalTransformationContent.cta.backgroundImage}')` }}
            />
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h3 className="text-2xl font-extrabold tracking-tight text-white sm:text-3xl md:text-4xl lg:text-5xl font-bricolage">
                        {digitalTransformationContent.cta.title}
                    </h3>
                    <div className="mt-8 flex justify-center">
                        <Link
                            href={digitalTransformationContent.cta.buttonHref}
                        ...
                        >
                            {digitalTransformationContent.cta.buttonText}
                            <ArrowUpRightIcon className="h-4 w-4" />
                        </Link>
                    </div>
                </motion.div>
