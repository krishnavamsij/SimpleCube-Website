...
function ProductDevelopmentHero() {
    return (
        <section className="relative overflow-hidden py-20 pt-32 sm:py-28 sm:pt-36 md:py-32 md:pt-44 lg:py-36 lg:pt-48">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    >
                        {productDevelopmentContent.hero.title}
                    </motion.h1>
                    <motion.p
                        variants={fadeInUp}
                        className="mt-4 text-lg text-slate-200 sm:text-xl"
                    >
                        {productDevelopmentContent.hero.subtitle}
                    </motion.p>
                    <motion.div
                        variants={fadeInUp}
                        className="mt-8"
...
function ProductDevelopmentIntro() {
    return (
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div className="text-base leading-relaxed text-slate-600 sm:text-lg whitespace-pre-line">
                        {productDevelopmentContent.intro.description}
                    </div>
                </motion.div>
            </div>
        </section>
...
function ServicesGrid() {
    const { services } = productDevelopmentContent;
...
function DeliveryEnablers() {
    const { deliveryEnablers } = productDevelopmentContent;
...
function ProductDevelopmentCTA() {
    return (
        <section className="relative overflow-hidden py-20 sm:py-24">
            {/* Background */}
            <div 
                className="absolute inset-0 bg-cover bg-center bg-no-repeat"
                style={{ backgroundImage: `url('${productDevelopmentContent.cta.backgroundImage}')` }}
            />
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h3 className="text-2xl font-extrabold tracking-tight text-white sm:text-3xl md:text-4xl lg:text-5xl font-bricolage">
                        {productDevelopmentContent.cta.title}
                    </h3>
                    <div className="mt-8 flex justify-center">
                        <Link
                            href={productDevelopmentContent.cta.buttonHref}
                        ...
                        >
                            {productDevelopmentContent.cta.buttonText}
                            <ArrowUpRightIcon className="h-4 w-4" />
                        </Link>
                    </div>
                </motion.div>
