...
import { ArrowUpRightIcon, Monitor, Calculator, Shield } from "lucide-react";
...
function ServiceCard({
    ...
    service: (typeof insuranceContent.capabilities.services)[number];
    index: number;
}) {
        ...
        <section className="relative overflow-hidden py-20 pt-32 sm:py-28 sm:pt-36 md:py-32 md:pt-44 lg:py-36 lg:pt-48">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    >
                        {insuranceContent.hero.title}
                    </motion.h1>
                    <motion.p
                        variants={fadeInUp}
                        className="mt-4 text-lg text-slate-200 sm:text-xl"
                    >
                        {insuranceContent.hero.subtitle}
                    </motion.p>
                    <motion.div
                        variants={fadeInUp}
                        className="mt-8"
                    >
                        <Link
                            href={insuranceContent.hero.contactButton.href}
                        ...
                        >
                            {insuranceContent.hero.contactButton.text}
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h3 className="text-xl font-bold leading-snug sm:text-2xl md:text-3xl mb-4 text-blue-900">
                        {insuranceContent.intro.title}
                    </h3>
                    <p className="text-base leading-relaxed text-slate-600 sm:text-lg">
                        {insuranceContent.intro.description}
                    </p>
                </motion.div>
            </div>
        </section>
...
function Capabilities() {
    const { capabilities } = insuranceContent;
...
function DeliveryEnablers() {
    const { deliveryEnablers } = insuranceContent;
...
function InsuranceCTA() {
    return (
        <section className="relative overflow-hidden py-20 sm:py-24">
            ...
            <div 
                className="absolute inset-0 bg-cover bg-center bg-no-repeat"
                style={{ backgroundImage: `url('${insuranceContent.cta.backgroundImage}')` }}
            />
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h3 className="text-2xl font-extrabold tracking-tight text-white sm:text-3xl md:text-4xl lg:text-5xl font-bricolage">
                        {insuranceContent.cta.title}
                    </h3>
                    <div className="mt-8 flex justify-center">
                        <Link
                            href={insuranceContent.cta.buttonHref}
                        ...
                        >
                            {insuranceContent.cta.buttonText}
                            <ArrowUpRightIcon className="h-4 w-4" />
                        </Link>
                    </div>
                </motion.div>
