...
import { ArrowRightIcon, Bot, Users, CreditCard, Cloud, Smartphone, TrendingUp, Monitor, Calculator, Shield, RefreshCw, BarChart, Network, Route, BrainCircuit, Zap, LineChart, Workflow } from "lucide-react";
import { Navbar } from "@/components/navbar";
import { Footer } from "@/components/footer";
import { Faq } from "@/components/faq";
import { insuranceFaqs } from "@/content/industry-faqs";
            ...
            <div className={`${CONTAINER_CLASS} text-left md:text-center relative z-10`}>
                ...
                >
                    {insuranceContent.impact.stats.map((stat, index) => (
                        ...
                        >
                            <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-white mb-2 sm:mb-3 md:mb-4 font-display text-center whitespace-nowrap">
                                {stat.value}
                            </div>
                            <div
