...
import { ArrowRight, Bot, Users, CreditCard, Cloud, Smartphone, TrendingUp, Monitor, Calculator, Shield, RefreshCw, BarChart, Network, Route, BrainCircuit, Zap, LineChart, Workflow } from "lucide-react";
            ...
            <div className={`relative z-10 ${CONTAINER_CLASS} text-center`}>
                ...
                >
                    <motion.div variants={fadeInUp} className="flex justify-center">
                        <span className="eyebrow text-[#3886CE] bg-[#3886CE]/10 border border-[#3886CE]/20 px-5 py-2 rounded-full text-xs font-bold tracking-[0.25em] flex items-center gap-2 uppercase">
            ...
            <div className={`${CONTAINER_CLASS} text-left md:text-center relative z-10`}>
                ...
                >
                    {wealthAssetManagementContent.impact.stats.map((stat, index) => (
                        ...
                        >
                            <div
                                className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-white mb-2 sm:mb-3 font-display text-center"
