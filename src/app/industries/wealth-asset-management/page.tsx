        ...
        <section className="relative overflow-hidden py-32 pt-44 sm:py-40 sm:pt-52 md:py-48 md:pt-60 lg:py-56 lg:pt-72 flex items-center min-h-screen">
            ...
            <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 text-center">
                ...
                >
                    ...
                    <motion.h1
                        variants={fadeInUp}
                        className="text-4xl sm:text-5xl lg:text-[64px] font-extrabold text-white leading-[1.15] tracking-tight font-display w-full lg:whitespace-nowrap mx-auto text-center"
                        dangerouslySetInnerHTML={{ __html: wealthAssetManagementContent.hero.title }}
                    />
                    
                    <motion.p
                        variants={fadeInUp}
                        className="text-lg sm:text-xl md:text-2xl text-slate-300 font-medium leading-relaxed w-full lg:whitespace-nowrap mx-auto pt-2"
